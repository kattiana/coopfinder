...
# Ou usando a linha de código abaixo:
 ...
 #tabCont <- read.csv('qui2_twoStrategies2x2_interestIn.csv', row.names=1, sep=",")
 #tabCont <- read.csv('qui2_twoStrategies2x3_interestIn.csv', row.names=1, sep=",")
 #tabCont <- read.csv('qui2_twoStrategies2x2_familiarity.csv', row.names=1, sep=",")
 tabCont <- read.csv('qui2_twoStrategies2x3_familiarity.csv', row.names=1, sep=",")
 #tabCont <- read.csv('qui2_twoStrategies2x2_devRecommendations.csv', row.names=1, sep=",")
